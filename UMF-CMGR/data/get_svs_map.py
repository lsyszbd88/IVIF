...
if __name__ == '__main__':
    ...
    # 使用绝对路径，不受 CWD 影响
    import pathlib
    DATASET = pathlib.Path(__file__).resolve().parent.parent.parent / "dataset"

    ir_path = str(DATASET / "raw/ctrain/Road/ir")
    vi_path = str(DATASET / "raw/ctrain/Road/vi")

    ir_map_path = str(DATASET / "raw/ctrain/Road/ir_map")
    vi_map_path = str(DATASET / "raw/ctrain/Road/vi_map")
