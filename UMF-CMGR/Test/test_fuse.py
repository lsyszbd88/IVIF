...
def hyper_args():
    ...
    # dataset
    parser.add_argument('--ir',default='/home/liusy/IVIF/dataset/raw/ctest/Road/ir_reg', type=pathlib.Path)
    parser.add_argument('--vi',default='/home/liusy/IVIF/dataset/raw/ctest/Road/vi', type=pathlib.Path)
    # checkpoint
    parser.add_argument('--ckpt', default='/home/liusy/IVIF/UMF-CMGR/cache/Fusion_only/220507_fusion_w_svm/fus_0200.pth', help='weight checkpoint', type=pathlib.Path) # weight/default.pth
    parser.add_argument('--dst', default='/home/liusy/IVIF/UMF-CMGR/results_Road/Fusion/220507_fusion_w_svm/', help='fuse image save folder', type=pathlib.Path)
