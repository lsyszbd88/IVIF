...
def hyper_args():
    ...
    # dataset
    parser.add_argument('--ir_reg', default='/home/liusy/IVIF/dataset/raw/ctrain/Road/ir_reg', type=pathlib.Path)
    parser.add_argument('--vi',     default='/home/liusy/IVIF/dataset/raw/ctrain/Road/vi', type=pathlib.Path)
    parser.add_argument('--ir_map', default='/home/liusy/IVIF/dataset/raw/ctrain/Road/ir_map', type=pathlib.Path)
    parser.add_argument('--vi_map', default='/home/liusy/IVIF/dataset/raw/ctrain/Road/vi_map', type=pathlib.Path)
    # train loss weights
    ...
    parser.add_argument('--ckpt', default='/home/liusy/IVIF/UMF-CMGR/cache/Fusion_only/220507_fusion_w_svm', help='checkpoint cache folder')
...
def train(args, tqdm_loader, optimizer_fus, FuseNet, criterion_fus, epoch):
    ...
    print(f"Epoch {epoch:4d} | loss={loss_avg:.4f}")
    try:
